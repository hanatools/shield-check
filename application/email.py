...
def generate_html_email(
    user_full_name, unit_name, leave_date, approval_url, approvers, MAIL_DEFAULT_SENDER
):
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td class="content-block">
                    ...
                    <p>
                      Bạn có thể phê duyệt bằng cách trả lời email này với tiêu đề chứa thông tin sau:
                      <strong>[Approve: {approval_url}]</strong>
                    </p>
                    <p>
                      <a href="mailto:{MAIL_DEFAULT_SENDER}?subject=Approve%20{approval_url}" class="reply-button">
                        Trả lời để phê duyệt
                      </a>
                    </p>
                  </td>
                </tr>
