...
#               <p><strong>Ngày xin phép:</strong> {day}/{month}/{year}</p>
#             </div>
#             <p>
#               Kính thưa Thủ trưởng,
#               <br />
#               Tôi, <strong>{user_full_name}</strong>, xin phép trình bày đơn xin phép ra ngoài
#               vào ngày <strong>{day}/{month}/{year}</strong>.
#             </p>
#             <p>
#               Tôi xin cam kết hoàn thành nhiệm vụ được giao trước khi xin phép
#               và sẽ trở lại đơn vị đúng thời hạn, tuân thủ mọi quy định của đơn vị.
#             </p>
#             <p>
#               Rất mong Thủ trưởng xem xét và chấp thuận đơn xin phép của tôi.
#             </p>
#             <a href="{verify_url}" class="button" target="_blank">Xác nhận Đơn Xin Phép</a>
#             <p>
#               Nếu bạn không nhấn được nút trên, bạn có thể nhấn vào liên kết dưới đây:
#               <br />
#               <a href="{verify_url}" class="fallback-link" target="_blank">{verify_url}</a>
#             </p>
#           </div>
#           <div class="footer">
